...
| Kubernetes Addon | [aurora-database-insights-exporter](./aurora-database-insights-exporter/) | [Rust](./aurora-database-insights-exporter/Cargo.toml) | Active | Prometheus exporter for AWS Aurora MySQL Database Insights (Performance Insights) metrics with YACE-style auto-discovery (Helm chart available) |
...
Standalone Helm charts have been migrated from [younsl/charts](https://github.com/younsl/charts) into the [charts](./charts/) directory of this monorepo and are distributed via OCI artifacts on GHCR.
