...
```console
crane ls ghcr.io/younsl/charts/ec2-scheduler
```
...
Install the chart with the release name `ec2-scheduler`:

```console
helm install ec2-scheduler oci://ghcr.io/younsl/charts/ec2-scheduler
```

Install with custom values:

```console
helm install ec2-scheduler oci://ghcr.io/younsl/charts/ec2-scheduler -f values.yaml
```

Install a specific version:

```console
helm install ec2-scheduler oci://ghcr.io/younsl/charts/ec2-scheduler --version 0.1.0
```

### Install from local chart

Download ec2-scheduler chart and install from local directory:

```console
helm pull oci://ghcr.io/younsl/charts/ec2-scheduler --untar --version 0.1.0
helm install ec2-scheduler ./ec2-scheduler
```
...
```console
helm upgrade ec2-scheduler oci://ghcr.io/younsl/charts/ec2-scheduler
```

## Uninstall

```console
helm uninstall ec2-scheduler
```
