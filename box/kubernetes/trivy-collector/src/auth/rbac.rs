...
p, role:admin, *, *, allow"#
    ...
    pub fn get_permissions(&self, user_groups: &[String]) -> UserPermissions {
        UserPermissions {
            ...
            can_manage_alerts: self.is_allowed(user_groups, "alerts", "create"),
            // View flags drive Admin sub-nav tab visibility. Separated from
            // the *_manage flags so a user with read-only access still sees
            // tabs they can actually open.
            can_view_alerts: self.is_allowed(user_groups, "alerts", "get"),
            can_view_clusters: self.is_allowed(user_groups, "clusters", "get"),
        }
    }
}
...
pub struct UserPermissions {
    ...
    pub can_manage_alerts: bool,
    pub can_view_alerts: bool,
    pub can_view_clusters: bool,
}
...
"#;
    ...
    fn test_get_permissions() {
        ...
        assert!(admin_perms.can_manage_alerts);
        ...
        assert!(!readonly_perms.can_manage_alerts);
    }
