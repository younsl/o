...
```console
helm install trivy-collector oci://ghcr.io/younsl/charts/trivy-collector --version 0.2.0
```
...
```console
helm pull oci://ghcr.io/younsl/charts/trivy-collector --untar --version 0.2.0
