...
- Watches Trivy Operator CRDs (VulnerabilityReports, SbomReports)
- Sends reports to central server via HTTP
- Lightweight, minimal resource usage

**Server Mode** (Central cluster):
- Receives reports from collectors
- Stores in SQLite database
- Serves web UI and REST API
- Optional: Watch local cluster's Trivy reports
