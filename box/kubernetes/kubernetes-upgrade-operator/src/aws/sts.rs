//! STS presigned token generation and crypto helpers for EKS authentication.
...
// ============================================================================
// Base64 decode (standard) - for CA certificate parsing
// ============================================================================
...
pub fn pem_to_der_certs(pem_data: &[u8]) -> Result<Vec<Vec<u8>>> {
