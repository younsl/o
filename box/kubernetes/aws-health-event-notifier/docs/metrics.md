...
- `outcome`: `ok` | `error`.
- `reason` (drop cause): `deny_category` | `deny_service` | `deny_region` | `deny_event_code` | `category_not_allowed` | `service_not_allowed` | `region_not_allowed` | `event_code_not_allowed` | `cold_start_suppressed`.
