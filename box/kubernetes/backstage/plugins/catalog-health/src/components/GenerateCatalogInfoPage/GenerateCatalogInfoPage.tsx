...
import { Alert, Box, Button, Container, Flex, Grid, HeaderPage, Link, Select, Tag, TagGroup, Text, TextField } from '@backstage/ui';
import { catalogHealthPlugin } from '../../plugin';
  ...
  return (
    <>
      <HeaderPage
        ...
        customActions={
          <TagGroup>
            <Tag id="plugin-id" size="small">{catalogHealthPlugin.getId()}</Tag>
          </TagGroup>
        }
      />
      <Container my="4">
