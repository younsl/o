...
import { Alert, Container, Flex, PluginHeader, Tag, TagGroup, Text } from '@backstage/ui';
import { RiDashboardLine } from '@remixicon/react';
import { grafanaDashboardMapPlugin } from '../../plugin';
  ...
  return (
    <>
      <PluginHeader
        ...
        title="Grafana Dashboard Map"
        customActions={
          <TagGroup>
            <Tag id="plugin-id" size="small">{grafanaDashboardMapPlugin.getId()}</Tag>
          </TagGroup>
        }
      />
      <Container>
