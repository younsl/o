...
import { PluginHeader, Container, Flex, Tag, TagGroup, Text, Box, Tabs, TabList, Tab, TabPanel, ButtonLink } from '@backstage/ui';
import { RiBookOpenLine } from '@remixicon/react';
import { openApiRegistryPlugin } from '../../plugin';
  ...
  return (
    <>
      <PluginHeader
        ...
        customActions={
          <TagGroup>
            <Tag id="plugin-id" size="small">{openApiRegistryPlugin.getId()}</Tag>
          </TagGroup>
        }
      />
      <Container>
