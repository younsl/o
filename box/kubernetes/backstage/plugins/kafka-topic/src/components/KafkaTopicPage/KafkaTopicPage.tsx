...
import { RiAddLine, RiArrowLeftLine, RiArrowRightSLine, RiFileSearchLine, RiPlugLine, RiUserFill, RiUserLine } from '@remixicon/react';
import { useApi } from '@backstage/core-plugin-api';
import { useAsyncRetry } from 'react-use';
import { Routes, Route, useNavigate, useParams } from 'react-router-dom';
import { kafkaTopicPlugin } from '../../plugin';
  ...
  return (
    <>
      <PluginHeader
        ...
        customActions={
          <TagGroup>
            <Tag id="plugin-id" size="small">{kafkaTopicPlugin.getId()}</Tag>
          </TagGroup>
        }
      />
      <Container my="4">
