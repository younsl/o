 ...
 *
 * No tooltip. A copy icon needs no label to be understood, and one popover per
 * row in a table of thirty is thirty overlays waiting to fire at a pointer
 * crossing the column. The check mark is the confirmation, and the aria-label
 * carries the same words to anyone who cannot see it.
 */
