...
**[ij](https://github.com/${REPOSITORY}/tree/main/box/tools/ij)** (Instance Jump) - Interactive EC2 Session Manager connection tool with fuzzy search and port forwarding.
